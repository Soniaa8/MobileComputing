...
private fun setMapLongClick(
    ...
    map.setOnMapLongClickListener { flatlng ->
        ...
        map.addMarker(
            MarkerOptions().position(flatlng).title("Reminder location").snippet(snippet)
        ).apply {
            navController.previousBackStackEntry
                ?.savedStateHandle
                ?.set("flocation_data", flatlng)
        }
    }
}